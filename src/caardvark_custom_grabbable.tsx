...
import { AvComposedEntity, EntityComponent, AvGadget, AvGadgetInfo, AvHeadFacingTransform } from '@aardvarkxr/aardvark-react';
import { AvMenuItem, AvModel, AvTransform, AvGadgetList, MoveableComponent, MoveableComponentState } from '@aardvarkxr/aardvark-react';
import { NetworkedGadgetComponent, RemoteGadgetComponent  } from '@aardvarkxr/aardvark-react';
...
/** Props for {@link CaCustomGrabbable} */
...
export class CaCustomGrabbable extends React.Component< StandardGrabbableProps, StandardGrabbableState >
{
	public moveableComponent: MoveableComponent;
